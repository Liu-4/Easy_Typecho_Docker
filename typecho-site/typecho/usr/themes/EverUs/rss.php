...
{
    $apiUrl = Helper::options()->links.'api/greader.php';
            ...
            if (isset($subscriptions['subscriptions'])) {
                ...
                foreach ($articles['items'] as $article) {
                    ...
                    $formattedArticle = array(
                        ...
                        'site_url' => $article['origin']['htmlUrl'],
                        'title' => $article['title'],
                    ...
                    if (isset($subscriptionMap[$subscriptionId])) {
                        ...
                        $filename = Helper::options()->links.substr($iconUrl, strrpos($iconUrl, '/') + 1);
...
// 调用函数并提供用户名和密码
getAllSubscribedArticlesAndSaveToJson(Helper::options()->User_name, Helper::options()->api_password);