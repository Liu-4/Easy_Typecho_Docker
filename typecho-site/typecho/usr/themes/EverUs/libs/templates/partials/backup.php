...
<?php
echo '
    <form class="backup" action="?EverUs_backup" method="post">
        <input class="layui-btn layui-btn-normal" type="submit" name="type" value="备份设置" />
        <input class="layui-btn layui-btn-warm" type="submit" name="type" value="还原备份" />
        <input class="layui-btn layui-btn-danger" type="submit" name="type" value="删除备份" />
    </form>';
